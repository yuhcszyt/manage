...
<link rel="stylesheet" type="text/css" id="skin" prePath="${ctx}/static/Qui/"/>
...
<style>
img {
	behavior:url("${ctx}/static/Qui/libs/js/method/pngFix/pngbehavior.htc");
}
</style>
<!--修正IE6不支持PNG图end-->

<!--动画方式入场效果start-->
<script type="text/javascript" src="${ctx}/static/Qui/libs/js/pic/jomino.js"></script>
<script>
	 $(function(){
		$(".navIcon").jomino();
	});
				...
				<tr height="146">
					<td width="260">
						<div class="navIcon" onclick="top.Dialog.alert('个人中心')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/01.png"/></div>
					...
					<td width="260">
						<div class="navIcon" onclick="top.Dialog.alert('个人收藏夹')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/02.png"/></div>
							<div class="navIcon_right">
					...
					<td width="260">
						<div class="navIcon" onclick="top.Dialog.alert('高级搜索')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/03.png"/></div>
							<div class="navIcon_right">
				...
				<tr height="146">
					<td>
						<div class="navIcon" onclick="top.Dialog.alert('文档管理')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/04.png"/></div>
							<div class="navIcon_right">
					...
					<td>
						<div class="navIcon" onclick="top.Dialog.alert('帮助中心')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/05.png"/></div>
							<div class="navIcon_right">
					...
					<td>
						<div class="navIcon" onclick="top.Dialog.alert('个人存储空间')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/06.png"/></div>
							<div class="navIcon_right">
				...
				<tr height="146">
					<td>
						<div class="navIcon" onclick="top.Dialog.alert('附件管理')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/07.png"/></div>
							<div class="navIcon_right">
					...
					<td>
						<div class="navIcon" onclick="top.Dialog.alert('通知消息')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/08.png"/></div>
							<div class="navIcon_right">
					...
					<td>
						<div class="navIcon" onclick="top.Dialog.alert('回收站')" style="display:none;">
							<div class="navIcon_left"><img src="${ctx}/static/Qui/libs/icons/png_128/09.png"/></div>
							<div class="navIcon_right">
